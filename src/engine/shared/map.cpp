...
public:
	...
	virtual int GetDataSize(int Index) const { return m_DataFile.GetDataSize(Index); }
	virtual int GetItemSize(int Index) const { return m_DataFile.GetItemSize(Index); }
